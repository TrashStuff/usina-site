...
const nosDescription = "Usina é uma produtora formada pela dupla Hugo Rocha e Miguel Mermelstein." "Criamos soluções sonoras para projetos audiovisuais." "Produzimos trilhas sonoras e cuidamos de todas as etapas de finalização de áudio para filmes, podcasts, publicidade, instalações e teatro.";
